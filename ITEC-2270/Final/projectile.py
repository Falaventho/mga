...
class Projectile:
    ...
    """Simulates the flight of simple projectiles near the earth's surface, ignoring wind resistance. Trackign is done in two dimensions, height (y) and distance (x)."""
